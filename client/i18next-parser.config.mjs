...
export default {
  ...
  defaultValue: (locale, _, key, value) => (locale == 'es' ? value || key : key),
  ...
  input: 'src/modules/batuta/platform/components/customPlatform/**/*.{jsx,js,tsx,ts}',
  ...
  failOnUpdate: process.env === 'production',
